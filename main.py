...
class Car:
	...
	def random_sprite(self):
		self.car_sprite = pygame.image.load('carImg/' + random.choice(self.car_sprites) + '.png')
	...
	def draw_radars(self, screen):
		for r in self.radars:
			p, d = r
			pygame.draw.line(screen, (158,232,55), self.center, p, 1)
			pygame.draw.circle(screen, (158,232,55), p, 5)
...
if __name__ == "__main__":
	...
	road = pygame.image.load("roadImg/road-1.png")
